<?php
	...
	echo "<link href=\"https://fonts.googleapis.com/css?family=Averia+Serif+Libre|Noto+Serif|Tangerine\" rel=\"stylesheet\">";
	...
	echo "<title>This should be update by PHP</title>";
	echo "</head>";
	echo "<body>"; 
?>
